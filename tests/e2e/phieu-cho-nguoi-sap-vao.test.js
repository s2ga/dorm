...
module.exports = {
  ...
  async run(t) {
    ...
    const sapVao = async ma => (await t.db.query(
      `INSERT INTO students (code,name,gender,birth_date,room_id,planned_check_in,status,rental_type,cccd_front,cccd_back)
       VALUES ($1,$1,'male','2004-05-06',$2,$3,'in','ghep','test/f.jpg','test/b.jpg') RETURNING id`, [ma, rid, lichVao])).rows[0].id;
